...
bkcore.hexgl.ShipControls = function(ctx)
{
    ...
    else if(ctx.controlType == 4 && bkcore.controllers.OrientationController.isCompatible())
    {
        this.orientationController = new bkcore.controllers.OrientationController(
            ...
            function(granted, message) {
                // Permission callback
                if (!granted) {
                    console.warn('Orientation permission denied:', message);
    ...
    function onKeyDown(event)
    {
        switch(event.keyCode)
        {
            ...
            case 37: /*left*/self.key.ltrigger = true; break;
            case 39: /*right*/self.key.rtrigger = true; break;
    ...
    function onKeyUp(event)
    {
        switch(event.keyCode)
        {
            ...
            case 37: /*left*/self.key.ltrigger = false; break;
            case 39: /*right*/self.key.rtrigger = false; break;
